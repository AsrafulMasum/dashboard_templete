    ...
    },
    {
      ...
      render: (_, record) => (
        <div className="flex items-center gap-2">
          <img
            src={
              record?.user?.image?.startsWith("https")
                ? record?.user?.image
    ...
    },
    {
      ...
      render: (_, record) => (
        <div className="flex items-center gap-2">
          <img
            src={
              record?.artist?.image?.startsWith("https")
                ? record?.artist?.image
          ...
          />
          <p>
            {record?.artist?.firstName} {record?.artist?.lastName}
          </p>
        </div>
      ),
    },
        ...
        <div className="mt-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-[5px]">
              ...
              <p className="text-right">
                {invoiceData?.artist?.firstName} {invoiceData?.artist?.lastName}{" "}
              </p>
              ...
              <p className="text-right">
                {moment(invoiceData?.createdAt).format("L")}
              </p>
