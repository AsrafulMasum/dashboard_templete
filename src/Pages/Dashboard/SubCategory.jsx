...
const SubCategory = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (value) {
        await updateSubCategory({ id: value?._id, updatedData: formData })
          .unwrap()
          .then(({ status, message }) => {
            if (status) {
    ...
    },
    {
      ...
      render: (_, record, index) => (
        <div
          ...
          style={{ background: record?.colors[0] }}
        />
      ),
    },
    {
      ...
      render: (_, record, index) => (
        <div
          className="h-10 w-10 rounded"
          style={{ background: record?.colors[1] }}
        />
      ),
    },
    {
      ...
      render: (_, record) => (
        <div className="flex items-center gap-2">
          <FiEdit
            onClick={() => (setValue(record), setOpen(true))}
        ...
        >
          ...
          >
            <ColorPicker
              ...
              onChange={(e) =>
                setColors({ ...colors, colors1: e.toHexString() })
              }
            />
          </Form.Item>
          ...
          >
            <ColorPicker
              ...
              onChange={(e) =>
                setColors({ ...colors, colors2: e.toHexString() })
              }
            />
          </Form.Item>
